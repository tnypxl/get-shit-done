...
**`checkin_granularity`** (default: `phase`)

- `phase`: Check in between phases (least interruption, current default behavior)
- `wave`: Check in between waves within a phase
- `plan`: Check in after each plan completes (runs plans sequentially)
